...
- En realidad necesitas mutación visible. Eso es un caso real
  ...
  use. Lo veremos con calma en el capítulo 10.
...
algebraicos del capítulo 9; lo que cambia es la cara que muestra
...
distinción la veremos en el capítulo 10.
...
capítulo 9 — pero también ahí lo que puede fallar aparece en el
...
cierto. Lo es y no lo es. El capítulo 9 le dedica todo el
