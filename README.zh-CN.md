...
验证。语言的里程碑按纪元划定,而不是按版本号:Orongo 将以
0.100.x 发布,路线图上**没有**"1.0"这个里程碑。
...
然后冠以"中文版"的名义出版。原因写在书的开头:本项目把"简单"
看作一种主动的选择,把"容易"和"简单"区分开;一份用机器翻译
拼出来的中文版,虽然*容易*交付,却不简单——它会让中文读者读到
一位**没有口音的作者**,这恰好与本书的精神相反。
